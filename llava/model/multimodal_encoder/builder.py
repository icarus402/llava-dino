...
from .rad_dino import RadDinoTower
...
def build_vision_tower(vision_tower_cfg, **kwargs):
    ...
    if vision_tower.startswith("rad_dino"):
        return RadDinoTower(vision_tower, args=vision_tower_cfg, local_model_path="/home/hanruize/rad-dino", **kwargs)
