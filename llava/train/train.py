...
#从模型的所有参数中，筛选出与LoRA相关的参数，并安全地收集它们
...
#将原始对话数据转换为LLaMA-2格式，并进行分词和标签掩码处理
